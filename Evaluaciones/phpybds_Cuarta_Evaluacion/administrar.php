		        ...
		        <tbody>
		         <?php while($fila=$resultado->fetch_assoc()){ ?>
		          <tr>
		            ...
		            <td><a href="inc/eliminar.php?id=<?php echo $fila['id']; ?>"><i class="mdi-action-highlight-remove small center "></i></a>
		            	<a href="#modificar<?php echo $fila['id']; ?>" class="modal-trigger"><i class="mdi-content-content-copy small center"></i></a>
		            </td>
